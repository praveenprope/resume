  ...
  return (
    <div className="p-8 bg-blue-50 min-h-screen">
      ...
      <div
        ...
        className="bg-white shadow-xl rounded-lg border border-gray-300 p-8 mx-auto"
        style={{
          width: "8.27in",
          minHeight: "11.69in",
          overflow: "hidden",
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-gray-300 pb-6">
          <div>
            <h1 className="text-5xl font-bold text-blue-800">Your Name</h1>
            <h2 className="text-xl text-gray-700">Senior Software Engineer</h2>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="mt-4">
            <h4 className="text-xl font-semibold text-blue-600">Apple Inc.</h4>
        ...
        <div className="mt-8">
          ...
          <div className="mt-4">
            <h4 className="text-xl font-semibold text-blue-600">Harvard University</h4>
        ...
        <div className="mt-8">
          ...
          <div className="flex flex-wrap gap-4 mt-4">
            <span className="px-4 py-2 bg-blue-100 text-blue-600 rounded-lg shadow-md">JavaScript</span>
            <span className="px-4 py-2 bg-blue-100 text-blue-600 rounded-lg shadow-md">React</span>
            <span className="px-4 py-2 bg-blue-100 text-blue-600 rounded-lg shadow-md">Node.js</span>
            <span className="px-4 py-2 bg-blue-100 text-blue-600 rounded-lg shadow-md">Python</span>
            <span className="px-4 py-2 bg-blue-100 text-blue-600 rounded-lg shadow-md">Django</span>
            <span className="px-4 py-2 bg-blue-100 text-blue-600 rounded-lg shadow-md">AWS</span>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="mt-4">
            <h4 className="text-xl font-semibold text-blue-600">Project Management Tool</h4>
            <p className="mt-2 text-gray-700">
              Developed an intuitive project management app to streamline workflows and enhance team collaboration.
            </p>
          </div>
          <div className="mt-4">
            <h4 className="text-xl font-semibold text-blue-600">Real-Time Chat App</h4>
            <p className="mt-2 text-gray-700">
